...
**GitHub Pages 版本**: https://davidlizhiwei.github.io/stock-app

> 💡 纯前端版本，无需安装，打开即用！需要输入你的 Finnhub API Key（免费获取）。
...
```
stock-app/
├── app.py              # Flask 主应用（后端版本）
├── .env                # 环境变量配置
├── .env.example        # 环境变量模板
├── requirements.txt    # Python 依赖
├── README.md          # 项目说明
├── static/            # 静态文件（Flask 版本）
│   ├── style.css      # 样式表
│   └── script.js      # JavaScript
├── templates/         # HTML 模板（Flask 版本）
│   └── index.html     # 主页面
└── docs/              # GitHub Pages 版本（纯前端）
